...
// chaining operators
const ᐅ = js.assign({ break: fold.break })(fns => over(call)(fns))
// NOTE(jordan): continue passing the target as the last argument
const ᐅdo = js.assign({ break: fold.break })(fns => target => {
...
const from_descriptors = descriptors => js.create(Object.prototype)(descriptors)
...
const zip   = ks  => vs => from_entries(interlace(ks)(vs))
...
const walk_breadth = js.assign({ recur: Symbol(`walk recur`) })(fn => ᐅ([
  ᐅdo([
    ...
    es => target => (
      map(ᐅwhen(ᐅ([ get(1), is(walk_breadth.recur) ]))(([ k ]) => [ k, walk_breadth(fn)(get(k)(target)) ]))(es)
    ),
  ]),
  from_entries,
]))
...
const walk_depth = js.assign({ recur: Symbol(`walk recur`) })(fn => ᐅ([
  ᐅdo([
    get.all.keys,
    ks => target => (
      map(k => [ k, ᐅwhen(is(walk_depth.recur))(_ => walk_depth(fn)(get(k)(target)))(fn([ k, target ])) ])(ks)
    ),
  ]),
  from_entries,
]))
  ...
  return harness.suite(`@prettybad/util: it's worse than underscore`, [
    ...
    t => t.suite(`getters`, [
      ...
      t => t.suite(`for_keys`, {
        ...
        'properties': [
          ...
          t => t.eq(get.for_keys.properties([ 'z' ])({ x: { y: 123 }, k: true }))
                   ([['z', None]]),
          t => t.eq(get.for_keys.properties([ sym_a ])(from_descriptors({ [sym_a]: d.nothing({ v: `hello` }) })))
                   ([
      ...
      t => t.suite(`in(<object>)`, {
        ...
        'for_keys': {
          ...
          'properties': [
            t => {
              const sym_a_hello = from_descriptors({ [sym_a]: d.nothing({ v: `hello` }) })
    ...
    t => t.suite(`objects`, {
      ...
      'from_descriptors: converts {[key]: desc, ...} to an object': [
        t => t.eq(from_descriptors({ a: d.default({ v: 5 }) }))({ a: 5 }),
        t => t.eq(from_descriptors({ a: d.nothing({ v: 5 }) }))
                 (js.create(Object.prototype)({ a: { value: 5 } })),
        t => t.eq(from_descriptors({ [sym_a]: d.enumerable({ v: 'hello' }) }))
      ...
      'merge_entries: merge objects by their entries': [
        t => { /* TODO */ },
      ],
      'merge_properties: merge arrays by their properties': [
        t => { /* TODO */ },
      ],

...
const set = js.assign({
  ...
  // path setters
  at_path: {
    value       : v  => at_path(set_value(v)),
    entry       : e  => at_path(set_entry(e)),
    values      : vs => at_path(set_values(vs)),
    entries     : es => at_path(set_entries(es)),
    property    : p  => at_path(set_property(p)),
    properties  : ps => at_path(set_properties(ps)),
    descriptor  : d  => at_path(set_descriptor(d)),
    descriptors : ds => at_path(set_descriptors(ds)),
  },
})(set_value)
